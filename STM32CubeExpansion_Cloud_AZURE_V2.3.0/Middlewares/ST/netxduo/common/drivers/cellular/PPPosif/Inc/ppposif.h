...
#define PRINT_PPPOSIF(format, args...)  TRACE_PRINT(DBG_CHAN_PPPOSIF, DBL_LVL_P0, "PPPosif:" format "\n\r", ## args)
#else
...
/**
  ...
  * @retval none
  */
extern void  ppposif_input(const struct netif_t *ppp_netif, ppp_pcb  *p_ppp_pcb, IPC_Device_t pDevice);
