...
static const CHAR manufacturer_property_value[] = APP_DEVICE_MANUFACTURER;
static const CHAR model_property_name[] = "model";
static const CHAR model_property_value[] = APP_DEVICE_MODEL;
...
static UINT append_properties(NX_AZURE_IOT_JSON_WRITER *json_writer)
{
    ...
    memset((void*)&info_ns, 0, sizeof(info_ns));
