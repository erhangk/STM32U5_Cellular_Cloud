...
/* With this sample example, Ping/com_ping module is unused */
#define USE_COM_PING              (0)  /* 0: not included */
...
/* With this sample example, Icc/com_icc is unused */
#define USE_COM_ICC               (0)  /* 0: not included */
